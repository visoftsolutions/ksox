...
export default function Buttons() {
  return (
    <div class="grid grid-cols-2 grid-rows-2 gap-6">
      <a href="/app" class="col-start-1 col-end-2 row-start-1 row-end-2">
      ...
      <A href="#section-1" class="col-start-2 col-end-3 row-start-1 row-end-2">
      ...
      <A href="/token" class="col-start-1 col-end-3 row-start-2 row-end-3">
