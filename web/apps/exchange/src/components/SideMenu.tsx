...
import SideMenuCircularButton from "~/components/SideMenu/CircularButton";
import { A } from "solid-start";
import { Nav, useNav } from "~/components/providers/NavProvider";
    ...
    <div class="grid h-full grid-rows-[76px_1fr_76px] items-start justify-center gap-4">
      <div class="row-start-1 row-end-2 py-4">
        <A href="/">
          <div>
            <img
              src={joinPaths(base, "/gfx/logo.png")}
              alt="ksox logo"
      ...
      <div class="row-start-2 row-end-3 grid items-center justify-center gap-4">
        ...
        >
          ...
          >
            <img
              src={joinPaths(base, "/gfx/side_menu_spot.svg")}
              alt="spot"
              class="h-[36px] w-[36px]"
            />
          </SideMenuCircularButton>
        ...
        <A href="/assets">
          <SideMenuCircularButton
            class="bg-gray-3"
            highlighted={nav() == Nav.Assets}
          >
            <img
              src={joinPaths(base, "/gfx/side_menu_assets.svg")}
              alt="assets"
              class="h-[36px] w-[36px]"
            />
          </SideMenuCircularButton>
