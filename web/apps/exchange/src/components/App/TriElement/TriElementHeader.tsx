...
export default function TriElementHeader(props: TriElementHeaderComponent) {
  return (
    ...
    >
      <div class="col-start-1 col-end-2 overflow-hidden text-ellipsis text-left">
        {props.column_0}
      </div>
      <div class="col-start-2 col-end-3">
        <div class="grid grid-cols-2 grid-rows-1 items-center justify-center">
          <div class="col-start-1 col-end-2 overflow-hidden text-ellipsis text-right">
            {props.column_1}
          </div>
          <div class="col-start-2 col-end-3 overflow-hidden text-ellipsis text-right">
            {props.column_2}
          </div>
        </div>
      </div>
