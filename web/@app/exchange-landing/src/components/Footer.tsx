        ...
        <footer>
          <div class="grid grid-cols-4 items-start justify-between gap-8 font-lexend text-text-1 max-lg:hidden">
            <div class="grid grid-flow-row gap-4">
              ...
              <a href="https://pay.ksox.finance" target="_blank">
                <Item
                  title="Payment Processor"
                  description="Payment Processor Platform"
                />
              </a>
              <a href="https://app.ksox.finance" target="_blank">
                <Item
                  title="Exchange App"
                  description="Exchange Trading Platform"
                />
              </a>
