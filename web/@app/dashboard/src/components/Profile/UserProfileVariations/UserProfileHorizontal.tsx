...
export default function UserProfileHorizontal(props: UserProfileComponent) {
    ...
    <div class={`w-full max-w-7xl bg-gray-2 ${props.styles}`}>
      <div class="flex h-full flex-row items-center">
        ...
        <div class="flex flex-col pb-8">
          {" "}
          {/* data without image */}
          <p class="pb-2 text-6xl font-extrabold">{props.name}</p>
          <div class="flex flex-row">
            <p class="text-xl">{props.publicWallet}</p>
          ...
          {/* buttons */}
          {/* <div class="flex flex-row">
            <Button onClick={() => {}} text="Add contact" color="ksox-1" styles="w-32 m-4"/>
            <Button onClick={() => {}} text="Message" color="ksox-1" styles="w-32 m-4"/>
          </div> */}
        </div>
      </div>
    </div>
