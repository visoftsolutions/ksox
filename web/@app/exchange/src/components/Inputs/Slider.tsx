...
import { Fraction, ev, fFromBigint, fmax, fmin, fmul } from "@web/types/primitives/fraction";
    ...
    <div class={`relative ${props.class} ${props.disabled ? props.disabledClass : ""}`}>
      ...
      <div class="flex-1 text-center">
        <input
          ...
          max={1000}
          step={1}
          value={ev(fmul(fmin(fmax(props.value, fFromBigint(0n)), fFromBigint(1n)), fFromBigint(1000n)))}
          ref={sliderDOM}
