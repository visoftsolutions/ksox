  ...
  return (
    <div>
      ...
      <NumberInput
        ...
        onChange={(base_val) => {
          const max_quote_asset_volume = fFromWei(props.available_balance ?? 0n);
      ...
      <SubmitRectangularButton
        ...
        onClick={async () => {
          console.log("BUY", storeComponent.base_asset_volume, storeComponent.quote_asset_volume)
          console.log("BUY", fToWeiCeil(storeComponent.base_asset_volume), fToWeiFloor(storeComponent.quote_asset_volume))
          const response = await fetch(`${api}/private/submit`, {
            ...
            body: JSON.stringify(
              SubmitRequest.parse({
                ...
                quote_asset_volume: fToWeiFloor(storeComponent.quote_asset_volume),
                base_asset_volume: fToWeiCeil(storeComponent.base_asset_volume),
              }),
