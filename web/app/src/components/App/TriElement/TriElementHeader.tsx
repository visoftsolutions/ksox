...
export default function TriElementHeader(props: TriElementHeaderComponent) {
  return (
    <div class={`relative grid grid-cols-[0.5fr_1fr] font-sanspro font-semibold text-gray-4 text-triElementHeader grid-rows-1 items-center justify-center ${props.class}`}>
