...
pub mod treasury {
    ...
    impl<M> ::core::fmt::Debug for Treasury<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Treasury))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Treasury<M> {
        ...
        pub fn withdraw_permit(
            ...
            self.0
                .method_hash([233, 222, 184, 236], (token, amount, deadline, v, r, s, to))
                .expect("method not found (this should never happen)")
        }
    ...
    impl ::ethers::core::abi::AbiEncode for TreasuryCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::WithdrawPermit(element) => ::ethers::core::abi::AbiEncode::encode(element),
            }
        }
    }
